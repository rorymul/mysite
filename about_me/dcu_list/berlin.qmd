...
theme:
  light: lux
---
![](berlin_pres.png){style="float: left; margin-right: 1rem; width: 30%;"}
...
![](work_bip.png){style="float: right; margin-left: 1rem; width: 20%;"}
...
![](exploring.gif){style="float: left; margin-right: 1rem; width: 20%;"}
...
Although, our days were filled with talks and team-work, we had a chance to explore the city and get involved in the night life. This is where we really got to know everyone involved and our friendship with everyone really came from.
